"""MongoDB repository for international Base & Precious Metals news (see
app/infra/mcx/metals_news_fetcher.py). Separate collection from
McxNewsRepository's "mcx_ng_news" so metals and NG articles never mix.
"""
