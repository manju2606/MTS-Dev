...
NIFTY_MIDCAP_100: list[str] = _dedup(
    NIFTY_MIDCAP_50
    + [
        "JKCEMENT.NS",
        "RAMCOCEM.NS",
...
NIFTY_MIDCAP_150: list[str] = _dedup(
    NIFTY_MIDCAP_100
    + [
        "CYIENT.NS",
        "INTELLECT.NS",
...
NIFTY_SMALLCAP_100: list[str] = _dedup(
    NIFTY_SMALLCAP_50
    + [
        "MAHINDCIE.NS",
        "SUBROS.NS",
...
NIFTY_SMALLCAP_250: list[str] = _dedup(
    NIFTY_SMALLCAP_100
    + [
        "TIMETECHNO.NS",
        "NIIT.NS",
...
NIFTY_MICROCAP_250: list[str] = _dedup(
    NIFTY_SMALLCAP_250
    + [
        "KORE.NS",
        "PARAS.NS",
...
NIFTY_200: list[str] = _index_symbols("in_nifty200", _dedup(NIFTY_100 + NIFTY_MIDCAP_100))
...
NIFTY_INDICES: dict[str, dict] = {
    ...
    "nifty_largemidcap250": {
        ...
        "cap": "Mid Cap",
        "symbols": NIFTY_LARGEMIDCAP_250,
    },
    "nifty_smallcap50": {
        "label": "NIFTY Smallcap 50",
        "cap": "Small Cap",
        "symbols": NIFTY_SMALLCAP_50,
    },
    "nifty_smallcap100": {
        "label": "NIFTY Smallcap 100",
        "cap": "Small Cap",
        "symbols": NIFTY_SMALLCAP_100,
    },
    "nifty_smallcap250": {
