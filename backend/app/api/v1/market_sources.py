    ...
    return [
        {
            "id":          "nse_india",
            "name":        "NSE India",
            "description": "Official NSE website JSON API — real-time equity quotes with full OHLCV",
        ...
        },
        {
            "id":          "yahoo",
            "name":        "Yahoo Finance",
            "description": "Yahoo Finance via yfinance — robust, covers NSE/BSE/global, historical data",
