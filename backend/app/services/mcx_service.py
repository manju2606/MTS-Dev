...
_HISTORY_PERIOD_MAP: dict[str, tuple[str, int]] = {
    ...
    "45m": ("60minute", 90),
    "1h": ("60minute", 90),
    # Kite has no native multi-hour interval (60minute is its finest above
    # 30minute) -- 4h/6h/8h reuse the same 60-minute candles as "1h"/"45m",
    # just bucketed wider by the prediction service (see
    # mcx_prediction_service.PERIOD_BUCKET_SECONDS).
    "4h": ("60minute", 90),
    "6h": ("60minute", 90),
    "8h": ("60minute", 90),
    "1D": ("day", 365),
